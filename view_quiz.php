...
<div id="info-area">
 ...
 <form action="" method="post" style="position:relative; padding:20px;  ">
    ...
    <input type="hidden" name="q_id" value="<?php echo $qid; ?>">
            ...
            <a href="instructor_course.php?c=<?php echo $c_id;?>&quizzes" class="btn btn-primary" style=" position:absolute; width:20%; right:3%;" ><?php if($num_x==1) {echo 'Leave '; } else {echo 'Join ';} ?> </a>
